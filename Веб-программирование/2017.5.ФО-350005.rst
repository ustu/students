...
.. list-table:: Успеваемость (`Веб-программирование <https://lectureswww.readthedocs.io/>`_)
   ...
   * - 3
     ...
     -                      `Mako <https://docs.google.com/document/d/1IMUQdzJaSk16tU94OyvoxvtUACE6u_Ov_7AIxIFCvNQ/edit>`__              `gh <https://github.com/mollyusk/Mako>`__                          
     -                                  
   ...
   * - 8
     ...
     -                      `Админка для телеграм-бота @urfu_bot (Flask) <url>`__                          
     -                                  
   ...
   * - 9
     ...
     -                      `Urldispatch <http://lectures.uralbash.ru/6.www.sync/3.framework/pyramid/5.urldispatch.html>`__                          
     -                                  
