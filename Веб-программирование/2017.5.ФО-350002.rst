...
.. list-table:: Успеваемость (`Веб-программирование <https://lectureswww.readthedocs.io/>`_)
   ...
   * - 5
     ...
     -                      `1 <https://github.com/ustu/lectures.www/issues/50>`__                          
   ...
   * - 8
     ...
     -                      `Агрегатор метео данных из различных источников <https://docs.google.com/document/d/1VCcqTpmNjz1LkeTnin1lHbUmxFXAYpvtp1mQ32Dv9Co/edit?usp=sharing>`__                          
