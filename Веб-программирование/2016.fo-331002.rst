...
.. list-table:: Успеваемость
   ...
   * - 8
     ...
     - отл.
     - отл.
     - Проектирование и разработка сайта о предоставлении услуг
   * - 9
...
.. |1.curs| replace:: Создание портала для размещения постов
.. _1.curs: https://github.com/KateBV/-Web
...
.. |7.curs| replace:: Небольшая социальная сеть
.. _7.curs: https://github.com/Dizrax/SocialNetwork
...
.. |11.curs| replace:: Разработка базы знаний по созданию предметов в игре «Divinity»
.. _11.curs: https://github.com/Porader/Pyramid_Divinity
