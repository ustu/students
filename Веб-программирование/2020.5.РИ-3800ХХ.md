...
- Матафонов Денис Сергеевич
  ...
  - Тема ИР: Конфигуратор бургера (команда). Набираем заказ по нескольким параметрам и оформляем заказ, даже без регистрации клиента - и заказы отправляются условным администраторам. 
